...
echo "seq $batch_start ${batch_end} | xargs -n 1 -I {} -P 15 python make_lightcurves_new.py --quarter ${quarter} --batch-index {} --tar-tpfs --tar-lcs --fit-va --augment-bkg --iter-neg --save-arrays feather --log 20"
seq $batch_start ${batch_end} | xargs -n 1 -I {} -P 15 python make_lightcurves_new.py --quarter ${quarter} --batch-index {} --tar-tpfs --tar-lcs --fit-va --augment-bkg --iter-neg --save-arrays feather --log 20
